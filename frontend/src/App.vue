          ...
          <div class="landing-grid">
            <div class="landing-hero">
              ...
              <p class="landing-desc">
                Varno naloži PDF dokumente, generiraj AI povzetke in postavljaj vprašanja nad
                vsebino dokumentov.
              </p>
              <div class="feature-grid">
                ...
                <div class="feature-item">
                  <span class="feature-dot dot-violet"></span>Prometheus
                </div>
              </div>
          ...
          <header class="topbar">
            <div class="topbar-left">
              ...
              <p class="page-subtitle">
                <template v-if="currentPage === 'documents'"
                  >Pregled, iskanje in upravljanje dokumentov</template
                >
                ...
                <template v-else-if="currentPage === 'admin'"
                  >Sistemske statistike in uporabniki</template
                >
              </p>
            </div>
