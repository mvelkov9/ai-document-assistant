<script setup>
  ...
  const sortedAnswers = computed(() => {
    ...
    return [...props.answers].sort((a, b) => new Date(a.created_at) - new Date(b.created_at))
  })
        ...
        <div class="chat-row chat-row-user">
          <div class="chat-bubble chat-bubble-user">
            ...
            <span class="chat-time"
              >{{ formatDate(answer.created_at) }} {{ formatTime(answer.created_at) }}</span
            >
          </div>
        </div>
        <!-- AI answer (left) -->
